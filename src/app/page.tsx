...
export default function Page() {
  ...
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-semibold text-slate-600">
                ...
                <div className="relative group/nav">
                    ...
                    <div className="absolute top-full left-0 mt-2 w-56 bg-white border border-slate-200 rounded-xl shadow-xl p-2 hidden group-hover/nav:block z-50">
                    ...
                    <div id="nav-user-dropdown" className={`vl-dropdown absolute right-0 top-[calc(100%+8px)] w-64 bg-white border border-slate-200 rounded-2xl shadow-2xl p-4 z-50 ${isDropdownOpen ? 'block' : 'hidden'}`}>
                        ...
                        <div className="flex items-center gap-3 mb-3 pb-3 border-b border-slate-100">
                            ...
                            <div className="overflow-hidden">
                                ...
                                <p id="nav-display-email" className="text-[10px] text-slate-400 truncate">{user.email}</p>
                            </div>
                        </div>
                        {/* Role badge */}
                    ...
                    {[...magazineCoversList, ...magazineCoversList].map((cover, i) => (
                        <a key={i} href={`/archives/covers/MAGAZINE COVER-${cover.title}`} 
                           className="flex-shrink-0 w-[200px] md:w-[260px] aspect-[3/4] relative group rounded-xl overflow-hidden shadow-md bg-slate-900 border border-slate-700/50 hover:border-amber-400/80 transition-all cursor-pointer">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-3 text-left">
    ...
    <section id="conference" className="py-20 md:py-24 bg-slate-50 border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 leading-relaxed mt-1">Investigating Ambedkar's constitutional principles (democracy, rule of law) in global frameworks.</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-brandBlue shrink-0 border border-slate-200"><i className="fa-solid fa-shuffle"></i></div>
                                <div>
                                    <h4 className="font-bold text-slate-800 text-sm">Intersectionality in Social Movements</h4>
                                    <p className="text-xs text-slate-500 leading-relaxed mt-1">Integrating caste, class, gender, and social identities in modern justice campaigns.</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-brandBlue shrink-0 border border-slate-200"><i className="fa-solid fa-book-open"></i></div>
                                <div>
                                    <h4 className="font-bold text-slate-800 text-sm">Ambedkar and Literature</h4>
                                    <p className="text-xs text-slate-500 leading-relaxed mt-1">Analyzing literary expressions of Dalit identity, resistance, and empowerment.</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-brandBlue shrink-0 border border-slate-200"><i className="fa-solid fa-person-booth"></i></div>
                                <div>
                                    <h4 className="font-bold text-slate-800 text-sm">Democracy & Political Empowerment</h4>
                                    <p className="text-xs text-slate-500 leading-relaxed mt-1">Investigating ideas on political representation and their role in inclusive democracy.</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-brandBlue shrink-0 border border-slate-200"><i className="fa-solid fa-palette"></i></div>
                                <div>
                                    <h4 className="font-bold text-slate-800 text-sm">Art & Cultural Resistance</h4>
                                    <p className="text-xs text-slate-500 leading-relaxed mt-1">Examining art and creative expressions as tools of resistance and transformation.</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-brandBlue shrink-0 border border-slate-200"><i className="fa-solid fa-shield-halved"></i></div>
                                <div>
                                    <h4 className="font-bold text-slate-800 text-sm">National Security & International Relations</h4>
                                    <p className="text-xs text-slate-500 leading-relaxed mt-1">Assessing perspectives on nation-building, security, and global geopolitics.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* Deadlines & Guidelines (Right 4 cols) */}
                <div className="lg:col-span-4 space-y-6">
                    {/* Important Dates Box */}
                    <div className="bg-brandDark text-white border border-slate-800 rounded-2xl p-6 shadow-md">
                        <h4 className="font-display text-sm font-bold uppercase tracking-widest text-amber-400 border-b border-slate-800 pb-3 mb-4">Important Dates</h4>
                        <div className="space-y-4 text-xs">
                            <div className="flex justify-between items-center py-1">
                                <span className="text-slate-400 font-medium">Abstract Deadline</span>
                                <span className="bg-amber-400/20 text-amber-300 font-bold px-2 py-0.5 rounded" data-field="conference.abstractDate">30th June 2026</span>
                            </div>
                            <div className="flex justify-between items-center py-1 border-y border-slate-800/80">
                                <span className="text-slate-400 font-medium">Acceptance Notification</span>
                                <span className="font-bold text-slate-200" data-field="conference.acceptanceDate">15th July 2026</span>
                            </div>
                            <div className="flex justify-between items-center py-1">
                                <span className="text-slate-400 font-medium">Full Paper Deadline</span>
                                <span className="font-bold text-slate-200" data-field="conference.paperDate">15th August 2026</span>
                            </div>
                            <div className="flex justify-between items-center py-2 border-t border-slate-800 text-sm">
                                <span className="text-amber-400 font-bold">Conference Date</span>
                                <span className="bg-brandBlue text-white font-bold px-2.5 py-1 rounded" data-field="conference.eventDate">18th Sept 2026</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
                        <h4 className="font-display text-sm font-bold text-slate-800 uppercase tracking-widest border-b border-slate-100 pb-3 mb-4">Submission Guidelines</h4>
                        <ul className="space-y-3 text-xs text-slate-600">
                            <li className="flex items-start gap-2">
                                <i className="fa-solid fa-circle-check text-emerald-500 mt-0.5"></i>
                                <span><strong>Abstracts:</strong> 300-500 words, outlining central arguments, methodology, and relevance.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <i className="fa-solid fa-circle-check text-emerald-500 mt-0.5"></i>
                                <span><strong>Full Papers:</strong> 4,000-6,000 words, academic formatting (upon acceptance of abstract).</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <i className="fa-solid fa-circle-check text-emerald-500 mt-0.5"></i>
                                <span><strong>Language:</strong> Must be in English and original research work.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <i className="fa-solid fa-circle-check text-emerald-500 mt-0.5"></i>
                                <span><strong>Biography:</strong> Max 150 words of authors included with submission.</span>
                            </li>
                        </ul>
                        <div className="mt-6 pt-4 border-t border-slate-100">
                            <a data-field="announcements.abstractLink" href="#contact" className="block text-center bg-brandBlue hover:bg-brandBlue/90 text-white font-bold py-3 rounded text-xs uppercase tracking-wider">
    ...
    <section id="events" className="py-20 md:py-24 bg-slate-50 border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-6">
            <div className="max-w-3xl mb-16 space-y-4">
                <span className="text-xs font-bold tracking-widest text-brandBlue uppercase">Schedule of Events</span>
                <h2 className="font-display text-3xl md:text-4xl font-black tracking-tight text-slate-900">Vishwa Leader London Summit 2026</h2>
                <p className="text-slate-500 leading-relaxed text-sm">
                    Three days of academic discourse, global business networking, and celebration of socio-cultural leadership in the heart of London, UK.
                </p>
            </div>
    ...
    {/* Section: Advertisers & Subscriptions */}
    <section id="advertisers" className="py-20 md:py-24 bg-white border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-6">
            <div className="max-w-3xl mb-16 space-y-4">
                <span className="text-xs font-bold tracking-widest text-brandBlue uppercase">Partner with Us</span>
                <h2 className="font-display text-3xl md:text-4xl font-black tracking-tight text-slate-900">Advertisers & Subscriptions</h2>
                <p className="text-slate-500 leading-relaxed text-sm">
                    Reach a global audience of academics, social advocates, and the global diaspora. Partner with Vishwa Leader through our monthly print periodical or digital portal.
                </p>
            </div>

            {/* Ad Layout Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-12">
                {/* Rates & Packages (Left 6 cols) */}
                <div className="lg:col-span-6 border border-slate-200 rounded-2xl p-8 bg-slate-50/50 flex flex-col justify-between">
                    <div>
                        <h3 className="font-display text-lg font-bold text-slate-900 mb-6 uppercase tracking-tight">Print & Digital Ad Packages</h3>
                        <div id="souvenir-rates-container" className="space-y-4 text-xs">
                            <div className="flex flex-wrap justify-between items-center gap-2 p-3.5 bg-white border border-slate-200/60 rounded-xl hover:shadow-sm transition-all">
                                <div className="flex-1 min-w-0">
                                    <h4 className="font-bold text-slate-800">Print: Full Page Color Ad</h4>
                                    <p className="text-slate-400 mt-0.5">Vishwa Leader Monthly Print Magazine</p>
                                </div>
                                <span className="bg-brandBlue/15 text-brandBlue font-bold px-3 py-1 rounded text-[11px] shrink-0">INR 25,000 / $300</span>
                            </div>
                            <div className="flex flex-wrap justify-between items-center gap-2 p-3.5 bg-white border border-slate-200/60 rounded-xl hover:shadow-sm transition-all">
                                <div className="flex-1 min-w-0">
                                    <h4 className="font-bold text-slate-800">Print: Half Page Color Ad</h4>
                                    <p className="text-slate-400 mt-0.5">Vishwa Leader Monthly Print Magazine</p>
                                </div>
                                <span className="bg-brandBlue/15 text-brandBlue font-bold px-3 py-1 rounded text-[11px] shrink-0">INR 15,000 / $200</span>
                            </div>
                            <div className="flex flex-wrap justify-between items-center gap-2 p-3.5 bg-white border border-slate-200/60 rounded-xl hover:shadow-sm transition-all">
                                <div className="flex-1 min-w-0">
                                    <h4 className="font-bold text-slate-800">Digital: Header Leaderboard (728x90)</h4>
                                    <p className="text-slate-400 mt-0.5">Monthly Slot on Digital News Portal</p>
                                </div>
                                <span className="bg-brandBlue/15 text-brandBlue font-bold px-3 py-1 rounded text-[11px] shrink-0">INR 10,000 / $125</span>
                            </div>
                            <div className="flex flex-wrap justify-between items-center gap-2 p-3.5 bg-white border border-slate-200/60 rounded-xl hover:shadow-sm transition-all">
                                <div className="flex-1 min-w-0">
                                    <h4 className="font-bold text-slate-800">Digital: Sponsored Press Release</h4>
                                    <p className="text-slate-400 mt-0.5">Featured Academic/Social Article Slot</p>
                                </div>
                                <span className="bg-brandBlue/15 text-brandBlue font-bold px-3 py-1 rounded text-[11px] shrink-0">INR 8,000 / $100</span>
                            </div>
                        </div>
                    </div>
                    <div className="mt-6 pt-4 border-t border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <span className="text-xs text-slate-500">* Special discounted rates apply for non-profits, academic conferences, and socio-economic institutions.</span>
                        <a href="wp-content/uploads/2021/02/ad-large.jpg" download="Vishwa_Leader_Ad_Rate_Card.jpg" className="inline-flex items-center gap-2 bg-brandBlue text-white font-bold px-4 py-2.5 rounded-lg text-[10px] hover:bg-brandBlue/90 transition-colors uppercase tracking-wider shadow-sm self-start sm:self-auto shrink-0">
                            <i className="fa-solid fa-download"></i> Download Rate Card
                        </a>
                    </div>
                </div>

                {/* Subscriptions & Interactive Estimator (Right 6 cols) */}
                <div className="lg:col-span-6 flex flex-col gap-6 justify-between">
                    {/* Interactive Booking Estimator Card */}
                    <div className="border border-slate-200 rounded-2xl p-8 bg-brandDark text-white shadow-md flex-1">
                        <h3 className="font-display text-lg font-bold text-amber-400 mb-4 uppercase tracking-tight">Interactive Ad & Subscription Estimator</h3>
                        <p className="text-xs text-slate-300 mb-6 leading-relaxed">Select your desired media promotion format below to calculate pricing estimate in real time.</p>

                        <div className="space-y-4 text-xs">
                            <div className="space-y-1.5">
                                <label className="font-bold uppercase tracking-wider text-slate-400">Media Package Type</label>
                                <select id="ad-type" onChange={() => {}} className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-slate-200 focus:outline-none focus:border-brandBlue text-xs">
                                    <option value="25000">Print: Full Page Color Ad (INR 25,000)</option>
                                    <option value="15000">Print: Half Page Color Ad (INR 15,000)</option>
                                    <option value="10000">Digital: Portal Header Banner (INR 10,000)</option>
                                    <option value="8000">Digital: Sponsored Article (INR 8,000)</option>
                                    <option value="1200">Print: 1-Year Reader Subscription (INR 1,200)</option>
                                </select>
                            </div>

                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="font-bold uppercase tracking-wider text-slate-400">Quantity / Months</label>
                                    <input type="number" id="ad-qty" value="1" min="1" onChange={() => {}} onInput={() => {}} className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-slate-200 focus:outline-none focus:border-brandBlue text-xs" />
                                </div>
                                <div className="space-y-1.5">
                                    <label className="font-bold uppercase tracking-wider text-slate-400">Estimated Total Cost</label>
                                    <div className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-amber-400 font-mono font-bold text-sm flex items-center">
                                        INR <span id="ad-cost" className="ml-1">25,000</span>
                                    </div>
                                </div>
                            </div>

                            <button onClick={() => {}} className="w-full bg-brandBlue hover:bg-brandBlue/90 text-white font-bold py-3.5 rounded-xl transition-colors uppercase tracking-wider text-xs shadow-md mt-2">
                                Request Reservation Booking
                            </button>
                        </div>
                    </div>

                    {/* Reader Subscription Summary */}
                    <div className="border border-slate-200 rounded-2xl p-6 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div className="space-y-1">
                            <h4 className="font-bold text-slate-800 text-sm">Become a Monthly Subscriber</h4>
                            <p className="text-xs text-slate-500">Get 12 issues of Vishwa Leader Monthly Print Magazine delivered to your door.</p>
                        </div>
                        <a href="#contact" className="self-start sm:self-auto bg-slate-900 text-white font-bold px-4 py-2.5 rounded-lg text-[10px] hover:bg-slate-800 transition-colors uppercase tracking-wider shrink-0">
                            Subscribe
                        </a>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="space-y-6 text-xs text-slate-700">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 mt-1" data-field="contact.phone">
                ...
                <div className="lg:col-span-7 border border-slate-200 rounded-2xl p-8 bg-white shadow-sm flex flex-col justify-center">
                    ...
                    <div id="inquiry-unauth-container" className="space-y-6 text-center py-6">
                        ...
                        <button onClick={() => {}} className="inline-flex items-center gap-3 bg-brandBlue hover:bg-brandBlue/95 text-white font-bold px-8 py-3.5 rounded-xl transition-all shadow-md text-xs uppercase tracking-wider mx-auto">
                            <i className="fa-brands fa-google text-sm"></i> Sign In with Google
                        </button>
                    </div>
